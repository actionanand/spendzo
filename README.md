...
https://actionanand.github.io/spendzo/
...
```bash
git clone https://github.com/actionanand/spendzo.git --branch 1-skeleton new-proj-name
```

```bash
npx degit github:actionanand/spendzo#1-skeleton new-proj-name
```

```bash
npx gitpick https://github.com/actionanand/spendzo -b 1-skeleton
```
